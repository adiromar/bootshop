...
<!-- fav and touch icons -->
    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/themes/images/ico/favicon.ico">
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/themes/images/logo.png" alt="Bootsshop"/></a>
